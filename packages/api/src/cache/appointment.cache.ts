...
export async function getCachedPatientAppointments(
  ...
  return appointmentService.getPatientAppointments(patientId, options);
}

// ==================== DOCTOR APPOINTMENTS ====================
export async function getCachedDoctorAppointments(doctorId: string, _clinicId: string, date?: Date) {
  'use cache';
